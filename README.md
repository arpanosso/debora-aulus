...
![](README_files/figure-gfm/unnamed-chunk-6-4.png)<!-- -->
    ...
    #> ------------------------------------------------------------------------
    #>              GL       SQ QM     Fc   Pr>Fc
    #> Bloco         1 0.000024  6 0.0057 0.93997
    #> Ingred.       1 0.019612  5 4.6813 0.03485
    #> Dose          3 0.003405  2 0.2709 0.84608
    #> Ingred.*Dose  3 0.012191  3 0.9700 0.41355
    #> Residuo      55 0.230424  4               
    #> Total        63 0.265657  1               
    #> ------------------------------------------------------------------------
    #> CV = 24.14 %
    #> 
